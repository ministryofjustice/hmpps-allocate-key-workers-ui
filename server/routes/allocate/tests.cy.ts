...
context('/allocate', () => {
  ...
  it('should only display results table when a filter is used', () => {
    ...
    cy.get('.govuk-table__row:nth-child(2) > :nth-child(1) > :nth-child(1)').should('have.attr', 'href').should(
      'equal',
      'http://localhost:3001/prisoner/AAA1234',
    ...
    cy.get('.govuk-table__row:nth-child(2) >:nth-child(3) > :nth-child(1) > :nth-child(2) > :nth-child(1)')
      ...
      .should(
        'equal',
        'http://localhost:3001/prisoner/AAA1234/alerts/active',
