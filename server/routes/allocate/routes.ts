...
export const AllocateStaffRoutes = ({ allocationsApiService, locationsApiService }: Services) => {
  const { router, get, post } = JourneyRouter()
  const controller = new AllocateStaffController(allocationsApiService, locationsApiService)
