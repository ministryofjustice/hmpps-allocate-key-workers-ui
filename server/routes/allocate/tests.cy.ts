...
context('/allocate', () => {
  ...
  it('should handle all sorting cases for alerts', () => {
    ...
    getRelevantAlertColumnForRow(1).find('a.govuk-link--no-visited-state').should('contain', '+2 active alerts')
    ...
    getRelevantAlertColumnForRow(3).find('.dps-alert-status--risk').should('contain', 'No one-to-one')
    getRelevantAlertColumnForRow(3).find('.dps-alert-status--security').should('contain', 'Risk to females')
    getRelevantAlertColumnForRow(4).find('.dps-alert-status--risk').should('contain', 'No one-to-one')
    getRelevantAlertColumnForRow(4).find('a.govuk-link--no-visited-state').should('contain', '+1 active alert')
    getRelevantAlertColumnForRow(5).find('.dps-alert-status--security').should('contain', 'Risk to females')
    getRelevantAlertColumnForRow(5).find('a.govuk-link--no-visited-state').should('contain', '+1 active alert')
    getRelevantAlertColumnForRow(6).find('a.govuk-link--no-visited-state').should('contain', '1 active alert')
