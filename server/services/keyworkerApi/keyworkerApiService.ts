...
export default class KeyworkerApiService {
  ...
  getKeyworkerMembers(req: Request, prisonId: string, query?: Parameters<KeyworkerApiClient['getKeyworkerMembers']>[1]): ReturnType<KeyworkerApiClient['getKeyworkerMembers']> {
